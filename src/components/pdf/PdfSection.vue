<template>
  <div class="bg-[#EFEFEF] px-8 flex flex-col rounded pb-4">
    <div class="flex flex-row justify-between py-4">
      <div class="color-[#303030] text-3xl font-thin">The study in a 6-pages snapshot</div>
      <div>
        <button
    ...
    <div>
      Access the recommendations of the full study and the four analysis dimensions of the value
      chain in this synthesis.
    </div>
