<template>
  <div class="flex flex-col w-[90%] lg:w-2/3 xl:w-1/2 ml-4 md:ml-12 relative mt-12">
    ...
    <div
      class="absolute top-10 transform -translate-x-1/2 -translate-y-full flex flex-col items-center"
...
const label = computed(() =>
  props.isPercent ? formatPercent(props.value) : formatNumber(props.value)
)
</script>
