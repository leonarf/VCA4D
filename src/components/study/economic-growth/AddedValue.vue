<template>
  ...
  <InfoTitle
    ...
    information="The sum of the VA generated by all the actors operating within the Value Chain limits (i.e. actors producing, processing or channelling the Value Chain product) is called Direct VA. It is composed of salaries and wages, land fees, royalties, financial charges (interest on loans), taxes on operations, depreciation and Net Operating Profits of the Value Chain direct actors."
  />
