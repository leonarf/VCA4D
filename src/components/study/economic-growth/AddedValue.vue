<template>
  ...
  <InfoTitle
    ...
    information="The sum of the VA generated by all the actors operating within the VC limits (i.e. actors producing, processing or channelling the VC product) is called Direct VA, while the sum of the VA generated by all the suppliers external to the VC (i.e. actors providing intermediate goods and services to the VC actors, therefore not handling nor processing the VC products) is called Indirect VA. The Total Value Added is the sum of the adds up these direct and indirect components, revealing the overall generation of VA entailed by the VC."
  />
