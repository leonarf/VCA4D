...
.browsable-radar-chart__item__question {
    display: flex;
    margin-bottom: 5px;
}

.browsable-radar-chart__item__question__label {
  width: 300px;
  margin-right: 15px;
}

.browsable-radar-chart__item__question__highlight {
    background: #444;
    width: 5px;
...
.browsable-radar-chart__item__question__answer__container {
  flex-grow: 1;
  display: flex;
  text-align: center;
