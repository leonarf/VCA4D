  ...
  <Skeleton>
    <div>
      ...
      <div
        ...
        v-dragscroll
        class="py-1 pb-16 px-4 sm:px-8 md:px-12 lg:px-40 xl:px-48 studies-wrapper"
      >
        <StudiesComparison :studies="studies" @select-studies="selectStudies($event)" />
      </div>
      <div
        v-else-if="loading === false"
        class="mx-4 mb-4 sm:mx-8 md:mx-12 lg:mx-40 xl:mx-48 no-study"
      >
